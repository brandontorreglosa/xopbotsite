...
app.use((req, res, next) => { if (!req.secure) return res.redirect('https://' + req.get('host') + req.url);
    next(); });
...
app.get("*", function(req, res) { res.sendFile(__dirname + "/xopbot/services/redirect/404/"); });
